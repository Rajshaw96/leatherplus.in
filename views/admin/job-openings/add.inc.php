...
<head>
    ...
    <title>Add New Job Opening - Admin</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add New Job Opening</h1>
                    </div>

                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Enter Job Opening Details</h6>
                        </div>

                        <div class="card-body">

                            <form action="<?= $url->baseUrl('models/admin/job-openings/add.php') ?>" method="POST" enctype="multipart/form-data">
                                <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="pref_candidates" required>
                                </div>

                                <div class="form-group">
                                    <label for="">Job Responsiblities</label>
                                    <textarea type="text" class="form-control" id="description" name="responsibilities" style="min-height:350px !important"></textarea>
                                </div>
