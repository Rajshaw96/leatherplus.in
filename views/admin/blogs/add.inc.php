...
<head>
    ...
    <title>Add New Blog Post - Admin</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?= $url->baseUrl('models/admin/blogs/add.php') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Enter Post Details</h6>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="description" name="description" style="min-height:350px !important"></textarea>
                                </div>
                            </div>
