            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Settings > Taxes > Edit</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Tax Details</h6>
                        </div>

                        <div class="card-body">
                            <form action="<?= $url->baseUrl("models/admin/settings-tax-edit.php") ?>" method="POST">
                                ...
                                <input type="hidden" name="tax_id" value="<?= $_GET['q'] ?>">

                                <div class="form-group">
                                    <label for="">Tax Name</label>
                                    <input type="text" id="tax_name" class="form-control" name="tax_name" value="<?= $tax_name ?>" required>
                                </div>

                                <div class="form-group">
                                    <label for="">Tax Value (in %)</label>
                                    <input type="text" id="tax_value" class="form-control" name="tax_value" onkeypress="return isNumberKey(event);" value="<?= $tax_value ?>" required>
                                </div>
