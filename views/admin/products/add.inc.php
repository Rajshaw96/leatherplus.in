        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?= $url->baseUrl('models/admin/products/add.php') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" value="<?= date('ymdhis') . rand(10000, 99999) ?>" id="prod_secret" name="prod_secret">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="shortdescription" name="product_shortdesc"></textarea>
                                </div>

                                <div class="form-group">
                                    <label for="">Product Description</label>
                                    <textarea type="text" class="form-control" id="description" name="product_desc" style="min-height:350px !important"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="product_type" id="product_type" class="form-control" onchange="enableAttributes()">
                                        ...
                                        <option value="A">Affilfiate</option>
                                    </select>
                                </div>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active p-3" id="general" role="tabpanel" aria-labelledby="general-tab">
                                        ...
                                        ?>
                                            <div class="form-group">
                                                ...
                                                <select name="tax" class="form-control">
                                                    <option value="0">None or Included</option>
                                                    <?php
                                                    if ($connStatus == true) {
                                                    ...
                                                    ?>
                                                                <option value="<?= $taxes_row['stax_id'] ?>"><?= $taxes_row['stax_name'] ?> (<?= $taxes_row['stax_value'] ?>%)</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="regularprice" class="form-control" name="regular_price" onkeypress="return isNumberKey(event)">
                                        </div>

                                        <div class="form-group">
                                            <label for="">Selling Price</label>
                                            <input type="text" id="saleprice" class="form-control" name="sale_price" onkeypress="return isNumberKey(event)">
                                        </div>
                                    ...
                                    <div class="tab-pane fade p-3" id="inventory" role="tabpanel" aria-labelledby="inventory-tab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="managestock" id="managestock" onchange="enableStock()">
                                        </div>
                                        ...
                                        ?>
                                                    <div class="form-group">
                                                        ...
                                                        <label class="form-check-label">
                                                            ...
                                                            <input type="checkbox" class="form-check-input" name="attributes[]" value="<?= $attributes['pattrib_id'] ?>" id=""><?= $attributes['pattrib_name'] ?>
                                                        </label>
                                                    </div>
                        ...
                        <div id="attributes" class="card shadow mb-4">
                                    ...
                                    <div class="col">
                                        ...
                                        <select class="form-control" id="material" onchange="fetchmaterials()" name="matattrib">
                                            ...
                                            ?>
                                                        ...
                                                        <option value="<?= $attributes['pattrib_id'] ?>"><?= $attributes['pattrib_name'] ?></option>
                                        ...
                                        ?>
                                                    <div class="form-group">
                                                        ...
                                                        <label class="form-check-label">
                                                            ...
                                                            <input type="checkbox" class="form-check-input" name="category[]" value="<?= $parentcats_row['pcat_id'] ?>" id=""> <?= $parentcats_row['pcat_name'] ?>
                                                        </label>
                                                    </div>
                                                    ...
                                                    ?>
                                                            <div class="form-group">
                                                                ...
                                                                <label class="form-check-label">
                                                                    ...
                                                                    <input type="checkbox" class="form-check-input" name="category[]" value="<?= $subcategory_row['pcat_id'] ?>" id=""><?= $subcategory_row['pcat_name'] ?>
                                                                </label>
                                                            </div>
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label class="form-check-label">
                                                                            ...
                                                                            <input type="checkbox" class="form-check-input" name="category[]" value="<?= $subcategory_row2['pcat_id'] ?>" id=""><?= $subcategory_row2['pcat_name'] ?>
                                                                        </label>
                                                                    </div>
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="">Product Tags / SEO Description</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="setas">
                                            ...
                                            <option value="R">Latest</option>
                                            <option value="L">Look Book</option>
                                            <option value="F">Top Rated</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
            ...
            <script>
                function fetchmaterials() {
                    ...
                    var request = $.ajax({
                        type: "POST",
                        url: "<?= $url->baseUrl('models/admin/ajax/fetchmaterials.php') ?>",
                        data: {
                            id: material
                        },
                        dataType: "html"
                ...
                function fetchmaterialsindd() {
                    ...
                    var request = $.ajax({
                        type: "POST",
                        url: "<?= $url->baseUrl('models/admin/ajax/fetchmaterialsindd.php') ?>",
                        data: {
                            id: material
                        },
                        dataType: "html"
            ...
            <script type="text/javascript">
                ...
                $('#productgallery').on('change', function() {
                    ...
                    if (size > 4) {
                        alert("Files must be between the size of 20 KB - 4 MB");
                        document.getElementById("productgallery").value = null;
                    } else {
                        $("#output").html('<b>' +
                            'Total file size is: ' + size + " MB" + '</b>');
                    }
                });
            </script>
